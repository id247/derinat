						...
						<div className="results-child__top">
							...
							<div className="results-child__info">
								...
								<div className="results-child__text text">
									...
									<p>
										Риск заражения ОРВИ и гриппом в этом году — <strong>{risk}%</strong>*
									</p>
									<p>
										<em>
					...
					<div className="results__boxes">
						...
						<div className="results__box results-box">
							...
							<div className="results-box__text text">
								...
								<ul>
									<li>
										<strong>Избегать прикосновений</strong> руками и посторонними предметами к своему лицу;
									</li>
									<li>
										<strong>Мыть руки перед приемом пищи</strong>.
									</li>
								</ul>
								...
								<ul>
									<li>
										<strong>Мыть руки с мылом</strong> не менее 10 секунд после возвращения с улицы и перед каждым приёмом пищи, тщательно протирая пальцы и ладони; 
									</li>
									<li>
										Микробы переносятся не только на коже человека, но и на его одежде. Очень важно <strong>переодеваться в домашнюю одежду</strong>, возвращаясь из школы и с прогулки;
									</li>
									<li>
										В большинстве случаев вирус попадает в организм человека через слизистую носа. Именно поэтому очень важно <strong>промывать нос после каждого посещения улицы или общественного места</strong>, наполняя его водой из ладоней, с последующим высмаркиванием. Чтобы защитить слизистую от попадания инфекции, рекомендуем использовать препарат Деринат, который укрепляет защитные силы слизистой оболочки носоглотки и обладает противовирусными свойствами.
									</li>
								</ul>
						...
						<div className="results__box results-box">
							...
							<div className="results-box__text text">
								...
								<ul>
									<li>
										<strong>Избегать контактов</strong> с больными людьми. <strong>Ограничить посещение культурно-массовых мероприятий</strong>, сократить время пребывания в местах скопления людей, пользоваться защитной маской;
									</li>
									<li>
										<strong>Высыпаться и правильно питаться</strong>. Защитить организм от вредных бактерий поможет употребление чеснока и лука, конечно, детям вряд ли понравятся такие меры, поэтому хотя бы включайте в ежедневный рацион ребенка свежие овощи и заставляйте пить много жидкости;
									</li>
									<li>
										<strong>Применять Деринат для защиты от вирусов</strong>, желательно несколько раз в день: утром перед школой, днем после школы, вечером и перед сном. Препарат оказывает иммуномодулирующее, противовирусное, противобактериальное и восстанавливающее действие.
									</li>
								</ul>
						...
						<div className="results__box results-box">
							...
							<div className="results-box__text text">
								...
								<ul>
									<li>
										Поддерживать в жилом помещении <strong>чистоту, комфортную температуру и проветривать</strong> комнаты при каждом удобном случае;
									</li>
									<li>
										Поддерживать в помещении <strong>влажность воздуха в пределах 40-60%</strong>. Для этого необходимо иметь гигрометр (прибор для измерения влажности) и средство для увлажнения (мойку воздуха, увлажнитель) или использовать подручные средства: ёмкости с водой, размещенные под батареей (например, цветочные балконные ящики), аквариум, живые цветы в горшках.		
									</li>
								</ul>
